...
PARAMETERS: p_cr RADIOBUTTON GROUP mode DEFAULT 'X'.
PARAMETERS: p_ve RADIOBUTTON GROUP mode USER-COMMAND umod.
...
PARAMETERS rb_tr   RADIOBUTTON DEFAULT 'X' GROUP typ.
...
SELECTION-SCREEN BEGIN OF LINE.
PARAMETERS rb_prog RADIOBUTTON GROUP typ USER-COMMAND utyp.
